...
const sheetVariants = cva(
  "fixed z-[110] gap-4 border-border bg-background p-6 shadow-[0_8px_24px_rgba(0,0,0,0.12)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
