...
export const Route = createFileRoute("/_app/crm/leads")({ component: () => {
  ...
  return <ModulePage title="Leads" description="All inbound and outbound leads." data={leads} columns={cols} searchKeys={["name","email","owner","country"]} primaryAction="Add Lead" />;
}});
