...
export const Route = createFileRoute("/_app/crm/customers")({ component: () => {
  ...
  return <ModulePage title="Customers" data={data} columns={cols} searchKeys={["name","email","country"]} primaryAction="Add Customer" onRowClick={(row) => navigate({ to: "/crm/customers/$id", params: { id: row.id } })} />;
}});
