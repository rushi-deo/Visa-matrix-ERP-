...
export const Route = createFileRoute("/_app/hr/employees")({ component: () => {
  ...
  return <ModulePage title="Employees" description="Manage your workforce." data={employees} columns={cols} searchKeys={["name","empId","department","role"]} primaryAction="Add Employee" onRowClick={(row) => navigate({ to: "/hr/employees/$id", params: { id: row.id } })} />;
}});
